...
/** Geometry data for the corridor animation */
...
/** Generate CSS keyframes for a single rail */
function buildKeyframes(dir: 1 | -1, name: string, p: Required<CorridorPath>) {
  const steps: string[] = [];
...
export function ImageStreamHero({
  ...
  className,
  ...rest
}: ImageStreamHeroProps & React.ComponentProps<'div'>) {
  ...
  return (
    <div
      ...
      style={{ containerType: "inline-size", ...rest.style }}
      {...rest}
    >
      <style>{css}</style>
      <div
